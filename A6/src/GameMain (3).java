 ...
 * Great!
 * This assignment was a little bit overwhelming because there are so many
 * different things to learn and they are scattered on different sites. However,
 * having demo codes were really
 * helpful in learning and completing this assignment.
 */
...
public class GameMain {
    ...
    private static void createAndShowGUI() {
        ...
        game.addPropertyChangeListener("GameScore",
            e -> scoreLabel.setText("Score: " + game.getScore()));
    ...
    private static JComponent makeSliderPanel(JSlider slider, String title) {
        ...
        // Replace this line with one that returns your panel
